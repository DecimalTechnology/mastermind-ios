...
class ReceivedTestimonialsScreen extends StatefulWidget {
  const ReceivedTestimonialsScreen({Key? key}) : super(key: key);

  @override
  State<ReceivedTestimonialsScreen> createState() =>
      _ReceivedTestimonialsScreenState();
}

class _ReceivedTestimonialsScreenState extends State<ReceivedTestimonialsScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await provider.loadReceivedTestimonials();
    });
  }
  ...
  Widget build(BuildContext context) {
    final receivedTestimonials =
        Provider.of<TestimonialProvider>(context).receivedTestimonials;
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              // Content
              Expanded(
                child: receivedTestimonials.isEmpty
                    ? _buildEmptyState()
                    : _buildTestimonialsList(receivedTestimonials),
              ),
            ],
          ),
        ),
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'You haven\'t received any testimonials yet.\nAsk people you\'ve worked with to give you testimonials!',
