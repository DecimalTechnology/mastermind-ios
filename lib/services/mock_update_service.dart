...
//   // Mock update check - replace this with your actual API call
...
//       // Mock latest version (you can change these values for testing)
//       String latestVersion = "1.0.1";
//       int latestBuildNumber = 2; // Higher than current build number
//       bool isForceUpdate = false; // Set to true for force update testing
...
//           whatsNew: '• Fixed connection issues\n• Improved app performance\n• Added new features\n• Enhanced user experience',
//         );
//       }
//     } catch (e) {
...
//         storeUrl = 'https://play.google.com/store/apps/details?id=com.example.master_mind';
